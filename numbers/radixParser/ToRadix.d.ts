 ...
 */
export type ToRadix<N extends number, R extends keyof Numbers = 10> = LessThan<N, R> extends true ? Numbers[Modulo<N, R> & keyof Numbers] : `${ToRadix<Divide<N, R>, R>}${Numbers[Modulo<N, R> & keyof Numbers]}`;
//# sourceMappingURL=ToRadix.d.ts.map